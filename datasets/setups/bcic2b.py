...
BASE_PATH = f"{WORKING_DIR}/../Datasets/BCI_Competition_IV/BCI_Competition_IV_2b"
os.makedirs(BASE_PATH, exist_ok=True)
SAVE_PATH = (
    f"{WORKING_DIR}/../Datasets/BCI_Competition_IV/BCI_Competition_IV_2b_preprocessed"
)
os.makedirs(SAVE_PATH, exist_ok=True)
DB_PATH = f"{WORKING_DIR}/databases/bcic2b.db"
...
for idx, filename in enumerate(pbar):
    ...
    try:
        ...
        # Scaling: 1e6
        epochs_data = epochs.get_data() * scaling_factor
